...
import { userProductsAction, loadProdFormAction, prodRemovedSuccessAction } from '../../store/actions/product'
...
const mapDispatchToProps = (dispatch, ownProps) => {
    return {
       ...
       onProdRemovedSucess: id => dispatch(prodRemovedSuccessAction(id)),
    }
}
