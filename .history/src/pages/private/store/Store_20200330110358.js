...
import { WithBlur, NumberDefault} from '../../../inputs/number'
        ...
        <>
            <Grid container spacing={1} style={{ marginTop: '15px' }}>
                ...
                <Grid item xs={5} sm={5} md={5}>
                    <Field name={'phone1'} label={'Telefone'} onBlur={e => getAddress(e)} 
                    component={NumberDefault} />
                </Grid>
                <Grid item xs={5} sm={5} md={5}>
                    <Field name={'phone2'} label={'Telefone (Opcional)'} component={NumberDefault} />
                </Grid>
            </Grid>
