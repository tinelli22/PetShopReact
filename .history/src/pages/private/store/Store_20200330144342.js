...
import { saveSomeDataFromUser } from '../../../services/userService'

function Store({ handleSubmit, change, uid, store }) {

    const [address, setAddress] = useState(store.address ? store.address : false)
        ...
        <form onSubmit={handleSubmit(onSave)}>
            <Grid container spacing={1} style={{ marginTop: '15px' }}>
                ...
                <Grid item xs={8} sm={8} md={8}>
                    <Field name={'address'} id={'add'} label={'Logradouro'} component={Default} />
                </Grid>
